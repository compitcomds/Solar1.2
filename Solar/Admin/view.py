...
@Admin.route("/")
def Admin_index():
    no_of_product=list(db.Product.find())
    no_of_Blog=list(db.blog.find())
    no_of_banner=list(db.banner.find())
    no_of_small_banner=list(db.smallbanner.find())
    return render_template('Admin_index.html',no_of_product=no_of_product,no_of_Blog=no_of_Blog,no_of_banner=no_of_banner,no_of_small_banner=no_of_small_banner)
